...
export const WebsiteStatusSchema = z.enum(["up", "down", "degraded", "unknown"]);
...
export const IncomingMessageSchema = z.discriminatedUnion("type", [
    ...
    z.object({ type: z.literal("validate"), data: ValidateIncomingMessageSchema }),
]);
...
export const OutgoingMessageSchema = z.discriminatedUnion("type", [
    ...
    z.object({ type: z.literal("validate"), data: ValidateOutgoingMessageSchema }),
]);
...
export type SignUpIncommingMessage = z.infer<typeof SignUpIncomingMessageSchema>;
export type ValidateIncommingMessage = z.infer<typeof ValidateIncomingMessageSchema>;
...
export type ValidateOutgoingMessage = z.infer<typeof ValidateOutgoingMessageSchema>;
